...
//        bind data to view
        ...
        if(walletOption.getType().equals("DEBIT")) {
            String fundedTxt = "Debited Amount :" + currency + walletOption.getAmount();
            holder.fundedAmount.setText(fundedTxt);

        }else{
            String fundedTxt = "Credited Amount :" + currency + walletOption.getAmount();
            holder.fundedAmount.setText(fundedTxt);
        }
