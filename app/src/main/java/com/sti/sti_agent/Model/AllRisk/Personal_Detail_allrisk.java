package com.sti.sti_agent.Model.AllRisk;

import io.realm.RealmList;
import io.realm.RealmObject;

public class Personal_Detail_allrisk extends RealmObject {
    ...
    RealmList<ItemDetail> itemDetails;

    public  Personal_Detail_allrisk(){
    ...
    public RealmList<ItemDetail> getItemDetails() {
        return itemDetails;
    }

    public void setItemDetails(RealmList<ItemDetail> itemDetails) {
