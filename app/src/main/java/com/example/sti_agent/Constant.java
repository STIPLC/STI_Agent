...
public static final String USER_TYPE = "user_type";
    ...
    public static final String BUSNIESS = "busniess";
    public static final String EMPLOYER_ADDR = "employer_addr";
    public static final String NEXT_OF_KIN = "next_of_kin";
    public static final String NEXT_OF_KIN_PHONE = "next_of_kin_phone";
