...
import com.sti.sti_agent.Model.ForgetPass.UserEmail;
...
import com.sti.sti_agent.Model.ForgetPass.UserNewPassPost;
...
public class ForgetPassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private void ValidateFormResetPass() {
        ...
        if (networkConnection.isNetworkConnected(this)) {
            ...
            if(!mNewPasswordEditxt.getText().toString().equals(confirm_password_editxt.getText().toString())){
