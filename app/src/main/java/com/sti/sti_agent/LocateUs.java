...
public class LocateUs extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(LocateUs.this, MainActivity.class);
